...
typedef int ListElement; //makes it so that we can change the element later on if need be
typedef struct ListObj *List; //We're not going to declare this as a pointer
