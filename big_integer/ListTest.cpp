...
int main() {
    ...
    cout << "A position is: " << A.position() << endl;
    ...
    A.moveFront();
    cout << "Position of 8: " << A.findNext(8) << endl;
    cout << "A position is: " << A.position() << endl;
    cout << endl;

    A.moveBack();
    cout << "Position of 8: " << A.findPrev(8) << endl;
    cout << "A position is: " << A.position() << endl;
    cout << endl;

    A.moveFront();
    cout << "A position is: " << A.position() << endl;
    cout << "Data in aftercursor is: " << A.peekNext() << endl;
    //cout << "Data in beforecursor is: " << A.peekPrev() << endl;
    A.moveBack();
    cout << "A position is: " << A.position() << endl;
    //cout << "Data in aftercursor is: " << A.peekNext() << endl;
    cout << "Data in beforecursor is: " << A.peekPrev() << endl;
    ...
    cout << "B position is: " << B.position() << endl;
    cout << "Data in A beforecursor is: " << A.peekPrev() << endl;
    cout << "Data in B beforecursor is: " << B.peekPrev() << endl;
    ...
    D.movePrev();
    D.movePrev();
    cout << "D position is: " << D.position() << endl;
    cout << "Data in D beforecursor is: " << D.peekPrev() << endl;
    cout << "D: " << D << endl;
    D.cleanup();
    cout << "D position is: " << D.position() << endl;
    cout << "Data in D beforecursor is: " << D.peekPrev() << endl;
